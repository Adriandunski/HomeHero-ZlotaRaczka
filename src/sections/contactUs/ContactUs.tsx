                    ...
                    <div className={'basis-1/2 flex flex-col gap-10 p-10 bg-white'}>
                        <div className={'flex'}>
                            <KafelekKontakt topic={'Zadzwon'}>
                                ...
                                <a href="tel:+48726270500" className={"text-lg text-neutral-600"}> 535 797 790</a>
                            </KafelekKontakt>
                            <KafelekKontakt topic={'Napisz'}>
                                ...
                                <a href="mailto:lukasz.ziemichod@wp.pl"
                                   className={"text-lg text-neutral-600"}> lukasz.ziemichod@wp.pl </a>
                            </KafelekKontakt>
                        </div>
                        <div className={'flex'}>
                            ...
                            <KafelekKontakt topic={'Facebook'}>
                                ...
                                <a href="mailto:patrycja.ceglarz@o2.pl "
                                   className={"text-lg text-neutral-600"}> <Link href={'https://www.facebook.com/homeheroLZ'}>HOME HERO</Link> </a>
                            </KafelekKontakt>
                        </div>
                    </div>
